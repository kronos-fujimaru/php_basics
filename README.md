...
C:￥itc￥php_exフォルダを作成し、各演習をPHPファイルを作成しなさい。<br>PHPの組み込み関数は、以下のもののみ使用可とする。
...
**CSVファイル（ex21_scores.csv）**<br>※以下のデータでCSVファイルを用意してください。
...
**CSVファイル（ex22_scores.csv）**<br>※以下のデータでCSVファイルを用意してください。
...
**出力結果**<br>以下のような内容のCSVファイル（**ex22_averages.csv**）を出力する。
...
**CSVファイル（ex23_file_a.csv）**<br>※以下のデータでCSVファイルを用意してください。
...
**出力結果**<br>以下のような内容のCSVファイル（**ex23_file_b.csv**）を出力する。
